...
const STRINGS = {
  en: {
    ...
    'apply.report.desc.workbench_overlay_unsupported': 'unsupported host or ambiguous Workbench path; CodeLens fallback remains',
  ...
  zh: {
    ...
    'apply.report.desc.workbench_overlay_unsupported': '宿主不支持或 Workbench 路径有歧义；保留 CodeLens 兜底',
