...
const STRINGS = {
  en: {
    ...
    'configure.feature_hunkwise':'Hunkwise per-hunk review (heavy)',
    'configure.experimental_hunkwise_desc_what':'Injects editorInsets Accept/Discard bars on every changed hunk.',
    'configure.experimental_hunkwise_desc_why':'Uses a private git baseline and full-workspace file watching — can feel slow on large repos.',
    'configure.experimental_hunkwise_desc_restore':'Leave off to use the lighter Session Edits panel instead. Re-apply after changing.',
  ...
  zh: {
    ...
    'configure.feature_hunkwise':'Hunkwise 逐段审查（较重，默认关）',
    'configure.experimental_hunkwise_desc_what':'在每个改动 hunk 上注入 Accept/Discard 编辑器内嵌条。',
    'configure.experimental_hunkwise_desc_why':'依赖私有 git baseline 与全工作区文件监视，大仓库可能明显卡顿。',
    'configure.experimental_hunkwise_desc_restore':'默认关闭；用轻量 Session Edits 面板即可。改完需重新 Apply。',
